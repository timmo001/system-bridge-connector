...
@pytest.mark.asyncio
async def test_delete(mock_http_client: ClientSessionGenerator):
    """Test the delete method."""
    client = await _get_http_client(mock_http_client)
...
@pytest.mark.asyncio
async def test_get(mock_http_client: ClientSessionGenerator):
    """Test the get method."""
    client = await _get_http_client(mock_http_client)
...
@pytest.mark.asyncio
async def test_post(mock_http_client: ClientSessionGenerator):
...
@pytest.mark.asyncio
async def test_put(mock_http_client: ClientSessionGenerator):
    """Test the put method."""
    client = await _get_http_client(mock_http_client)
...
@pytest.mark.asyncio
async def test_bad_request(mock_http_client: ClientSessionGenerator):
...
@pytest.mark.asyncio
async def test_not_found(mock_http_client: ClientSessionGenerator):
...
@pytest.mark.asyncio
async def test_unauthorised(mock_http_client: ClientSessionGenerator):
...
@pytest.mark.asyncio
async def test_timeout(mock_http_client: ClientSessionGenerator):
    """Test the timeout."""
    client = await _get_http_client(mock_http_client)
    with patch(
...
@pytest.mark.asyncio
async def test_connection_error(mock_http_client: ClientSessionGenerator):
